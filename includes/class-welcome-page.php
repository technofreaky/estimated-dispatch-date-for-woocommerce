<?php
class estimated_dispatch_date_woocommerce_welcome_page{
    public $plugin_slug;
    public $plugin_url;
    public $page_html;
    ...
    public function  __construct($args = array()){
		$default_args = array(
			'dbslug' => 'eddwc-',
			'welcome_slug' => 'eddwc-about',
			'wp_plugin_slug' => 'estimated-dispatch-date-woocommerce',
			'template' => __DIR__.'/welcome-page.php',
			'menu_name' => EDDWC_NAME,
			'plugin_file' => EDDWC_FILE,
			'plugin_name' => EDDWC_NAME,
			'version' => EDDWC_V,
			'txt_lang' => EDDWC_V,

			'wp_plugin_url' => 'https://wordpress.org/plugins/estimated-dispatch-date-woocommerce/',
			
			'tweet_text' => 'What A Aswome Plugin',
			'twitter_user' => 'varunsridharan2',
			'twitter_hash' => 'EDDWC',
			'gitub_user' => 'technofreaky',
			'github_repo' => 'estimated-dispatch-date-woocommerce',
