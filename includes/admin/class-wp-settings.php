 ...
 * @author keesiemeijer
 */
if ( !class_exists( 'Estimated_Dispatch_Date_For_WooCommerce_WP_Settings' ) ) {
	class Estimated_Dispatch_Date_For_WooCommerce_WP_Settings {
		...
		public function init( $pages, $page_hook = '' ) {
			...
			if ( !class_exists( 'Estimated_Dispatch_Date_For_WooCommerce_Settings_WP_Fields' ) ) {
				$this->debug  .= "Error: class Estimated_Dispatch_Date_For_WooCommerce_Settings_WP_Fields doesn't exist<br/>";
			}
			...
			$this->fields = new Estimated_Dispatch_Date_For_WooCommerce_Settings_WP_Fields( get_settings_errors() );
